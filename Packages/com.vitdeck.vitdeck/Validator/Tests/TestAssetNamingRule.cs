...
namespace VitDeck.Validator.Test
{
    public class TestAssetNamingRule
    {
        ...
        [TestCase("[\x21-\x7e]+", "Assets/VitDeck/Validator/Tests/Data/AssetNamingRule/CorrectName_!#$%&'()+,;=@{}~.prefab")]
        [TestCase(@"[a-zA-Z0-9 _\.\-]+", "Assets/VitDeck/Validator/Tests/Data/AssetNamingRule/CorrectName_-.prefab")]
        [TestCase(@"[a-zA-Z0-9 _\.\-]+", "Assets/VitDeck/Validator/Tests/Data/AssetNamingRule")]
        ...
        [TestCase("Assets/VitDeck/Validator/Tests/Data/AssetNamingRule/FailName_あああ.prefab")]
        [TestCase("Assets/VitDeck/Validator/Tests/Data/AssetNamingRule/FailFolderName_あああ")]
        public void TestValidateFailAssetName(string targetAssetPath)
        {
            ...
            var rule = new AssetNamingRule("アセット名使用禁止文字検出", pattern);
            var target = new ValidationTarget("Assets/VitDeck/Validator/Tests/Data/AssetNamingRule", assetPaths: targetAssetPaths);
            var result = rule.Validate(target);
