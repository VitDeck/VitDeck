...
namespace VitDeck.Validator.Test
{
    public class TestValidationTargetFinder
    {
        ...
        {
            var testFolder = ValidatorTestUtilities.TestDirectoryPath + "/ValidationTargetFinder";
        ...
        {
            var testFolder = ValidatorTestUtilities.TestDirectoryPath + "/ValidationTargetFinderNoObject";
            var finder = new ValidationTargetFinder();
            var rootObjects = finder.FindRootObjects(testFolder, true);
