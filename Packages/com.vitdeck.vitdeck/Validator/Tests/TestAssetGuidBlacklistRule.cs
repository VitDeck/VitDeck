...
namespace VitDeck.Validator.Test
{
    public class TestAssetGuidBlacklistRule
    {
        ...
        public void TestValidate()
        {
            ...
            var target = finder.Find("Packages/com.vitdeck.vitdeck/Validator/Tests/Data/AssetGuidBlacklistRule", true);
            ...
            Assert.That(result.Issues[0].message, Does.Contain("Packages/com.vitdeck.vitdeck/Validator/Tests/Data/AssetGuidBlacklistRule/Prohibited material.mat"));
        }
        [Test]
