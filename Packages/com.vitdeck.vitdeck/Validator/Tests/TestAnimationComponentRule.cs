...
namespace VitDeck.Validator.Test
{
    public class TestAnimationComponentRule
    {
        ...
        {
            var target = new ValidationTargetFinder().Find(ValidatorTestUtilities.DataDirectoryPath + "/AnimationComponentRule/EnableAlwaysAnimate", true);
        ...
        {
            var target = new ValidationTargetFinder().Find(ValidatorTestUtilities.DataDirectoryPath + "/AnimationComponentRule/DisableAlwaysAnimate", true);
            var issues = new AnimationComponentRule("").Validate(target).Issues;
