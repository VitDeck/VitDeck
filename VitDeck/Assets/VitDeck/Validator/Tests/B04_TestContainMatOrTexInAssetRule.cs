...
namespace VitDeck.Validator.Test
{
    public class TestContainMatOrTexInAssetRule
    {
        ...
        public void TestValidate()
        {
            ...
            var target = finder.Find("Assets/VitDeck/Validator/Tests/Data/B04_ContainMatOrTexInAssetRule/OK", true);
        ...
        public void TestValidateError()
        {
            var rule = new ContainMatOrTexInAssetRule("アセット内のMaterialやTextureの埋め込みを検証するルール");
            var finder = new ValidationTargetFinder();
            var target = finder.Find("Assets/VitDeck/Validator/Tests/Data/B04_ContainMatOrTexInAssetRule/NG", true);
            var result = rule.Validate(target);
            Assert.That(result.RuleName,Is.EqualTo("アセット内のMaterialやTextureの埋め込みを検証するルール"));
