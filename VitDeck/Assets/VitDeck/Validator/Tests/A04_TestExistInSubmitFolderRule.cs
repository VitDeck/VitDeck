...
namespace VitDeck.Validator.Test
{
	public class A04_TestExistInSubmitFolderRule
	{
		...
		public void TestValidateInSubmitFolder()
		{
			...
			Assert.That(issues[0].message, Is.EqualTo(String.Format("アセット{0}が入稿フォルダ内に含まれていません。", "Assets/VitDeck/Validator/Tests/Data/A04_ExistInSubmitFolderRule/CubePrefabInWrongFolder.prefab")));
			...
			Assert.That(issues[1].message, Is.EqualTo(String.Format("アセット{0}が入稿フォルダ内に含まれていません。", "Assets/VitDeck/Validator/Tests/Data/A04_ExistInSubmitFolderRule/MaterialInWrongFolder.mat")));
