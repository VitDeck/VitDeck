...
namespace VitDeck.Validator.Test
{
    public class TestAssetNamingRule
    {
        ...
        public void TestValidateCorrectAssetName()
        {
            ...
            var patternMatch = "^[\x21-\x7e]+$";

            var rule = new AssetNamingRule("アセット名使用禁止文字検出", patternMatch);
        ...
        public void TestValidateFailAssetName()
        {
            ...
            Assert.That(issue.message,
                        Is.EqualTo(string.Format("アセット名({0})に使用禁止文字が含まれています。(使用可能文字の範囲={1})", failFilename, patternMatch)));
