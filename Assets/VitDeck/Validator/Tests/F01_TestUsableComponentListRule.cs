    ...
    public class TestUsableComponentListRule
    {
        ...
        public void TestUnregisteredComponent()
        {
            var target = new ValidationTargetFinder()
                .Find("Assets/VitDeck/Validator/Tests/Data/F01_UsableComponentListRule", true);
        ...
        public void TestIgnoreAsset()
        {
            ...
            var ignoredPrefabGUID = AssetDatabase
                .AssetPathToGUID("Assets/VitDeck/Validator/Tests/Data/F01_UsableComponentListRule/Directional Light Prefab.prefab");
